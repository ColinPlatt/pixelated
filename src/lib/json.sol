        ...
        returns (string memory) 
    {
        return _prop(
                        ...
                        string.concat(
                            ...
                            encode(
                                bytes(string.concat(
                                    '<svg width="384" height="384" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">  <image width="384" height="384" image-rendering="pixelated" xlink:href="',
                                    _pngImg,
                                    '"/></svg>'
                                ))
                            )
